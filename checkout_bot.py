...
WebDriverWait(browser, 0).until(EC.element_to_be_clickable((By.XPATH, "/html/body/div[1]/main/div/div[2]/div/div[1]/div/div[1]/div[1]/section[1]/div[5]/ul/li/section/div[2]/div[2]/div/form/div[2]/fieldset/div[2]/div[1]/div/div[1]/span"))).click()
time.sleep(1)
...
# complete checkout
#place_order = browser.find_element('xpath', '/html/body/div[1]/div[2]/div/div[2]/div[1]/div[1]/main/div[3]/div[2]/div/section/div[2]/div/div[2]/div/button')
#browser.execute_script('arguments[0].click()', place_order)